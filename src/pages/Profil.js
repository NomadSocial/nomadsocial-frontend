...
const Profil = () => {
  ...
  useEffect(() => {
    ...
    axios.get("http://localhost:8000/api/features/all",
      {
        auth:
        {
          username: localStorage.getItem("email"),
      ...
      .then((response) => {
        ...
        response.data.map((feature) => {
          if (feature.multiple_choices === true) {
            setChoix(prevChoix => ({ ...prevChoix, [feature.name]: [feature.features[0].id] }))
          } else {
            setChoix(prevChoix => ({ ...prevChoix, [feature.name]: feature.features[0].id }))
          }
    ...
    axios.get("http://localhost:8000/api/me/features/",
      {
        auth:
        {
          username: localStorage.getItem("email"),
    ...
    axios.get("http://localhost:8000/api/me/worklocations/",
      {
        auth:
        {
          username: localStorage.getItem("email"),
      ...
      .catch((error) => { console.log(error) })
    axios.get("http://localhost:8000/api/me/availabilities/",
      {
        auth:
        {
          username: localStorage.getItem("email"),
  ...
  const handleChange2 = (event) => {
    ...
    if (event.target.multiple === false) {
      setChoix(prevChoix => ({ ...prevChoix, [event.target.name]: parseInt(event.target.value) }));
    } else {
  ...
  const handleClickDate = (event) => {
    event.preventDefault();
    axios.post("http://localhost:8000/api/me/availabilities/",
      {
        start: startDate,
        end: endDate
      },
  ...
  const handleClickZip = (id) => {
    axios.delete("http://localhost:8000/api/me/worklocations/" + id + "/",
      {
        auth: {
          username: localStorage.getItem("email"),
          password: localStorage.getItem("password"),
  ...
  const handleClickZipMod = (id) => {
    axios.patch("http://localhost:8000/api/me/worklocations/" + id + "/",
      {
        zipcode: 75001
      },
      {
  ...
  const handleClickAvailabilities = (id) => {
    axios.delete("http://localhost:8000/api/me/availabilities/" + id + "/",
      {
        auth: {
          username: localStorage.getItem("email"),
          password: localStorage.getItem("password"),
  ...
  const handleClickAvailabilitiesMod = (id) => {
    axios.patch("http://localhost:8000/api/me/availabilities/" + id + "/",
      {
        start: new Date(),
        end: new Date()
      },
    ...
    if (location.length === 0 && props.warn && availabilities.length === 0) {
      ...
      return (
        <div className="warning">
          ...
          <span><strong>Attention ! </strong>Vous devez remplir vos informations de localisation  et vos disponibilités !</span>
        </div>
      )
      ...
      return (
        <div className="warning">
          ...
          <span><strong>Attention ! </strong>Vous devez remplir vos informations de localisation et vos informations personnelles !</span>
        </div>
      )
      ...
      return (
        <div className="warning">
          ...
          <span><strong>Attention ! </strong>Vous devez remplir vos disponibilités et vos informations personnelles !</span>
        </div>
      )
      ...
      return (
        <div className="warning">
          ...
          <span><strong>Attention ! </strong>Vous devez remplir vos informations de localisation !</span>
        </div>
      )
    } else if (props.warn) {
      return (
        <div className="warning">
          ...
          <span><strong>Attention ! </strong>Vous devez remplir vos informations personnelles !</span>
        </div>
      )
      ...
      return (
        <div className="warning">
          ...
          <span><strong>Attention ! </strong>Vous devez remplir vos disponibilités !</span>
        </div>
      )
    } else if (!props.warn) {
      return null;
  ...
  return (
    <>
      ...
      <div className="profil-container">
        <form >
          ...
          <div className="profil">
            ...
            <DatePicker selected={startDate} locale="fr" dateFormat="dd/MM/yyyy" onChange={(date) => setStartDate(date)} />
          </div>
          <div className="profil">
            <label>date de fin :</label>
            <DatePicker selected={endDate} locale="fr" dateFormat="dd/MM/yyyy" onChange={(date) => setEndDate(date)} />
          </div>
          <div className="profil-button">
      ...
      <div className="home">
        <div className="left-home">
          <h1>Disponibilités</h1>
          {availabilities.length === 0 ? <p>aucune disponibilités renseignées</p> : availabilities.map((availability, key) => (
            <div className="zipcodes" key={key}>
